...
//Importing to Gen3
curl -X POST -v -k --insecure --location-trusted -F "file=C:\Users\mohpasha\.jenkins\workspace\OICDemo\BIREPORT_CS_01.00.0000.iar" -F 'type=application/octet-stream' 'https://design.integration.us-ashburn.ocp.oraclecloud.com/ic/api/integration/v1/integrations/archive?integrationInstance=TestInstance' --ssl-no-revoke --header "Authorization: $token_type$BEARER_TOKEN"
